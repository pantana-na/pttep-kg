...
- The Extractor, Retriever, and HAZOP agents frequently load static reference schemas (Refinery 5x5 RAM Matrix, ISO 14224 equipment taxonomies, and Hock Process chemical constraints) that rarely change.
...
*Report generated by Google Cloud FinOps & Principal Architecture Agent for Refinery Petrochemical Corporation (Refinery Group).*
